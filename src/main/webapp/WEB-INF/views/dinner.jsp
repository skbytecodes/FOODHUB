...
<head>
    ...
    <link rel="stylesheet" href="/FOODHUB/URLToReachResourcesFolder/css/dinner.css">
    <script src="/FOODHUB/URLToReachResourcesFolder/js/dinner.js"></script>
    <title>dinner</title>
</head>
<body>
    <nav class="navbar">
        ...
        <div class="login-cart">
            ...
            <a href="cart" class="cart-container">
                <img class="cart" src="/FOODHUB/URLToReachResourcesFolder/images/icons8-shopping-cart-96.png" alt="my-cart">
            </a>
    ...
    <div class="top-header">
        <img class="top-image" src="/FOODHUB/URLToReachResourcesFolder/images/roasted-turkey.jpg" alt="img">
    </div>
